            ...
            steps{
                script{
                    withCredentials([string(credentialsId: 'githubpattoken', variable: 'gitcred')]) {
                        ...
                        sh "git push --force https://{eliyazsyed22}:{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}@github.com/buchanancd-update.git HEAD:main"
