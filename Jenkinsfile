            ...
            steps{
                script{
                    withCredentials([string(credentialsId: 'githubpattoken', variable: 'gitcred')]) {
                        ...
                        //sh "git push --force https://{eliyazsyed22}:{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}@github.com/eliyazsyed22/buchanancd-update HEAD:main"
                        //sh "git pull origin main"
                        //sh "git config core.commentChar ";""
                        //sh "git remote add origin git@github.com:eliyazsyed22/buchanancd-update.git"
